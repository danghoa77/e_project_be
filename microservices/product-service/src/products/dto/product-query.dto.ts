// product-service/src/products/dto/product-query.dto.ts
...
export class ProductQueryDto {
    ...
    @IsIn(['price', '-price', 'createdAt', '-createdAt', 'name', '-name'], { message: 'Invalid sort value.' })
    sortBy?: string = 'createdAt'; // Default sort by newest creation date
}
